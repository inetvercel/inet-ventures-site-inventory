...
const SelectTrigger = ({
	...
	<SelectPrimitive.Trigger
		className={cn(
			"flex h-9 w-full items-center justify-between gap-2 rounded-md bg-card shadow-xs border border-input px-3 py-2 text-sm ring-offset-background placeholder:text-foreground/60 focus:outline-hidden focus:ring-1 focus:ring-ring disabled:cursor-not-allowed disabled:opacity-50 [&>span]:truncate [&>span]:text-left",
			className,
		)}
		{...props}
	>
